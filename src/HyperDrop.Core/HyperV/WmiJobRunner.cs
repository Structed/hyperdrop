...
internal static class WmiJobRunner
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            throw new HyperDropException(HyperVErrorMessages.ForMethodReturn(returnValue));
        }
    ...
    private static HyperDropException BuildFailure(ManagementObject job)
    {
        ...
        return new HyperDropException(message, HyperVErrorMessages.RemedyFor(description ?? message));
    }
