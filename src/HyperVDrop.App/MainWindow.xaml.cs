...
using HyperVDrop.App.Notifications;
using HyperVDrop.App.ViewModels;
using HyperVDrop.App.Views;
using HyperVDrop.Core.HyperV;
...
public partial class MainWindow : Window
{
    ...
    protected override async void OnContentRendered(EventArgs e)
    {
        ...
        catch (Exception ex)
        {
            MessageBox.Show(
                this,
                $"HyperVDrop could not read the virtual machine list.\n\n{ex.Message}",
                "HyperVDrop",
                MessageBoxButton.OK,
